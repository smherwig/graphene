...
CFLAGS = -Wall -std=c11 -gdwarf-2 -g3 -DDEBUG -fPIC -maes -U_FORTIFY_SOURCE -fno-stack-protector -fno-builtin -Wtrampolines -Wextra -Wnull-dereference -mrdrnd -DBR_GRAPHENE=1
CCOUT = -c -o 
