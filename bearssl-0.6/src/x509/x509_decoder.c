...
t0_parse7E_unsigned(const unsigned char **p)
{
	...
	for (;;) {
		unsigned y;
        debug_printf("t0_parse7E_unsigned\n");
	...
	void *append_dn_ctx)
{
	...
	*/
    ...
    debug_printf("br_x509_decoder_init: A\n");
	br_x509_decoder_init_main(&ctx->cpu);
    debug_printf("br_x509_decoder_init: B\n");
	br_x509_decoder_run(&ctx->cpu);
    debug_printf("br_x509_decoder_init: C\n");
}
...
#define T0_RET()        goto t0_next
	...
	t0_next:
		t0x = T0_NEXT(&ip);
        debug_printf("br_x509_decoder_run: t0x=%u\n", t0x);
