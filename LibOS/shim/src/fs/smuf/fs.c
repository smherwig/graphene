 ...
 */
static int
smuf_mount(const char *uri, const char *root, void **mount_data)
{
    int error = 0;
...
static int
smuf_lookup(struct shim_dentry *dent, bool force)
{
    (void)force;
...
static int 
smuf_mode(struct shim_dentry *dent, mode_t *mode, bool force)
{
    (void)mode;
